...
class kernel{
    ...
    public static enum opcodes {
        ...
        DONE, BAR, NOTVALID, LRT, ROR, XOR, BSZ, BSO, SSZ, SSO;
    ...
    opcodeTable.put("LRT"  , "11100");
    opcodeTable.put("ROR"  , "11110");
    opcodeTable.put("XOR"  , "11111");
    opcodeTable.put("BSZ"  , "01111");
    opcodeTable.put("BSO"  , "11101");
    opcodeTable.put("SSZ"  , "01011");
    opcodeTable.put("SSO"  , "10101");
	}
